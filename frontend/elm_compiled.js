		...
		switch (msg.$) {
			...
			case 'ChangeRegisterUsernameInput':
				...
				return _Utils_Tuple2(
					...
					elm$core$Platform$Cmd$none);
			case 'ChangeRegisterPasswordInput':
				var str = msg.a;
				return _Utils_Tuple2(
					_Utils_update(
						model,
															...
															[
																...
																_List_fromArray(
																	[
																		...
																		elm$html$Html$Events$onClick(author$project$Main$TryLogin)
																	]),
																_List_Nil)
															]))
													]))
...
var author$project$Main$RegisterUser = {$: 'RegisterUser'};
															...
															[
																...
																_List_fromArray(
																	[
																		...
																		elm$html$Html$Attributes$class('btn btn-primary'),
																		elm$html$Html$Events$onClick(author$project$Main$RegisterUser)
																	]),
																_List_Nil)
															]))
													]))
